    ...
    if ($profileFields) {
        foreach ($profileFields as $field) {
            ...
            if ($field->widgetEdit($profile)) {
                ...
                echo $form->textArea($profile, $field->varname, array('rows' => 6, 'cols' => 50,'span'=>5));
            } else {
                echo $form->textField($profile, $field->varname, array('size' => 60,'span'=>5, 'maxlength' => (($field->field_size) ? $field->field_size : 255)));
            }
